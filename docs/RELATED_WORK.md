...
This note situates **How Sharply Personas Switch Under Soft Steering** against the mentor-linked literature for
[How Sharply Personas Switch Under Soft Steering](https://github.com/alanasung/persona-continuity).

## Positioning

Test whether persona changes are discrete flips or continuous drifts under steering.

The design hypothesis is: Test whether persona changes are discrete flips or continuous drifts under steering.
