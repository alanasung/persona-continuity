"""Experiment stages for How Sharply Personas Switch Under Soft Steering."""
...
from .personas._util import ensure_dir, stage_result, write_json
...
def stage_report(cfg: DictConfig, run_dir: Path) -> dict[str, Any]:
    ...
    write_json(out / "report.json", {"headline": "How Sharply Personas Switch Under Soft Steering", "claims_gated": True})
