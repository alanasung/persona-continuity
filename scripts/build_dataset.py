...
def _registered_builder(name: str):
    ...
    try:
        module = importlib.import_module("personas.data")
...
def main(argv: list[str] | None = None) -> int:
    ...
    from personas.utils.run_manifest import utc_now_iso, write_json_atomic
    ...
    if builder is not None:
        ...
        source = f"personas.data.BUILDERS[{data.name!r}]"
        ...
        print(
            ...
            "src/personas/data/__init__.py under BUILDERS, or use data=synthetic "
