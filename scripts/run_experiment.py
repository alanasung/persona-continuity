...
from personas.configs.loader import register_schema
...
def _load_stage_registry(package: str = "personas") -> dict:
...
def _run_stages(cfg: DictConfig, run_dir: Path) -> dict:
    ...
    if unavailable:
        ...
        print(f"      in personas.stages: {unavailable}")
...
def main(cfg: DictConfig) -> None:
    ...
    from personas.configs.loader import config_to_dict, save_resolved_config
    from personas.models.device import get_device
    from personas.utils.logging import configure_logging
    from personas.utils.reproducibility import set_seed
    from personas.utils.run_manifest import create_run_dir, save_run_metadata
