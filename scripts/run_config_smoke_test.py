...
def _compose(preset: str | None, overrides: list[str]):
    from personas.configs.loader import load_config
...
def _smoke_one(preset: str | None, args: argparse.Namespace) -> int:
    from personas.configs.loader import save_resolved_config
    from personas.utils.git import git_state
...
def main(argv: list[str] | None = None) -> int:
    ...
    from personas.configs.loader import available_presets
