import json
from personas.reporting.aggregate import aggregate_results, flatten_metrics
from personas.reporting.tables import write_tables
from personas.reporting.figures import write_caption, write_figures
